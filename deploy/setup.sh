...
# Project Repo
# git clone https://github.com/RawanD201/Hawalan-website.git $project_path
...
ALTER USER 'root'@'localhost' IDENTIFIED WITH mysql_native_password BY 'sitedoctor';

    -   Flush Cache.
FLUSH PRIVILEGES;

    -   Create Database.
CREATE DATABASE sitedoctor;
