...
@section('content') 
<link rel="stylesheet" href="{{ asset('assets/css/inlineCSS/credential-check.css') }}">
	  ...
	  <div class="row" id="row">
	    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-6 offset-xl-3">
	      <div class="login-brand text-center">
	        <a href="{{ url('') }}"><img src="{{ asset('storage/app/public/assets/logo/logo.png') }}" alt="{{ config('settings.product_name') }}" width="200"></a>
	      </div>
...
@endsection
@push('scripts-footer')
<script src="{{ asset('assets/js/internal-js/credential_check.js') }}"></script>
@endpush
