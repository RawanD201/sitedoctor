...
@section('title',__("SiteDoctor - Terms of Service"))
    ...
    <div class="widget-wrapper">
      <div class="row">
        <div class="col-12" style="margin-top: 100px;">
          ...
          <h4 class="my-4">Parties to the terms of use agreement</h4>
          ...
          <h4 class="my-4">Hyperlinking to site, co-branding, “framing” and referencing website prohibited</h4>
          ...
          <h4 class="my-4">Disclaimer for contents of website</h4>
          ...
          <h4 class="my-4">Limitation of liability</h4>
          ...
          <h4 class="my-4">Indemnification</h4>
          ...
          <h4 class="my-4">User registration</h4>
          <p>
          ...
          <h4 class="my-4">Intellectual property rights</h4>
          <p>
          ...
          <h4 class="my-4">Site management</h4>
          <p>
          ...
          <h4 class="my-4">Term and termination</h4>
          <p>
