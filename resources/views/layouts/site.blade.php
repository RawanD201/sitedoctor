...
<html class="no-js" lang="">
  ...
  <body>
    ...
    <script>
      let logoSrc = "{{ asset('storage/app/public/assets/logo/logo.png') }}"
      let logoSrc2 = "{{ asset('storage/app/public/assets/logo/logo.png') }}"
      var browser_js_link="{{ asset('assets/js/analytics_js/useragent.js') }}";
