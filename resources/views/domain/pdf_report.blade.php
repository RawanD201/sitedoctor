<?php if($compare_report == 0) { ?>
	...
	if($load_css_js==1) {
		...
		echo "<div><p align='center'><a style='display: block; margin-left: auto; margin-right: auto; text-align: center;margin-top:40px;' href='".url("")."'><img style='max-width:200px;' src='".$base64."' alt='".config("settings.comapny_address")."'></a></p>";
	}
	else {
			...
			<div class="profile-card__cnt js-profile-cnt">
				...
				<div class="profile-card-loc">
					<span class="profile-card-loc__icon">
						<i class="fas fa-clock bg-secondary text-18"></i>&nbsp;
					</span>
	            ...
	            <div class="col-8 offset-2 p-1 text-center" id="progress_msg">
				...
				<div class="col-12 mt-4 d-none"  id="subscribe_div">
					<div class="card">				
							<h6 class="header_msg">Please provide your information, a download link will be sent to you</h6>					
						<div class="card-body">
							<div id="spinner" style="display: none;">
								<i class="fas fa-spinner fa-spin" style="font-size: 60px;color: #6777ef;margin-bottom:24px;"></i>
							</div>
...
<div class="<?php if($compare_report == 0) echo "container"; else echo "container-fluid"; ?>">
	<section class="section mt-3">
			...
			<div class="col-12">
				...
				<div class="card card-<?php echo $class; ?> is_pdf">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
							<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo1" aria-expanded="false" aria-controls="collapseTwo1" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
								<?php echo $recommendation_word; ?>
							</div>
							<div id="collapseTwo1" class="accordion-collapse collapse" >
								<div class="accordion-body section-lead alert alert-light long-recom">
		...
		<div class="row">
			<div class="<?php if($compare_report == 1 && $is_pdf == 1) echo 'col-12'; else echo 'col-6';?>">
				<?php 
				...
				<div class="card card-<?php echo $class; ?> is_pdf">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
							<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo2" aria-expanded="false" aria-controls="collapseTwo2" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
								<?php echo $recommendation_word; ?>
							</div>
			...
			<div class="<?php if($compare_report == 1 && $is_pdf == 1) echo 'col-12'; else echo 'col-6';?>">
				...
				<div class="card card-<?php echo $class; ?> is_pdf">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
							<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo3" aria-expanded="false" aria-controls="collapseTwo3" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
								<?php echo $recommendation_word; ?>
							</div>
		...
		<div class="row">
			...
			<div class="col-12">
				<div class="card card-<?php echo $class; ?> is_pdf">
					...
					<div class="card-body chart-responsive minus row">
			...
			<div class="<?php if($compare_report == 1 && $is_pdf == 1) echo 'col-12'; else echo 'col-6';?>">				
				...
				<div class="card card-<?php echo $class; ?> is_pdf">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
							<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo4" aria-expanded="false" aria-controls="collapseTwo4" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
								<?php echo $recommendation_word; ?>
							</div>
			...
			<div class="<?php if($compare_report == 1 && $is_pdf == 1) echo 'col-12'; else echo 'col-6';?>">				
				...
				<div class="card card-<?php echo $class; ?> is_pdf">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
						<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo9" aria-expanded="false" aria-controls="collapseTwo9" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
							<?php echo $recommendation_word; ?>
						</div>
			...
			<div class="<?php if($compare_report == 1 && $is_pdf == 1) echo 'col-12'; else echo 'col-6';?>">				
				...
				<div class="card card-<?php echo $class; ?> is_pdf">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
							<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo5" aria-expanded="false" aria-controls="collapseTwo5" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
								<?php echo $recommendation_word; ?>
							</div>
			...
			<div class="<?php if($compare_report == 1 && $is_pdf == 1) echo 'col-12'; else echo 'col-6';?>">				
				...
				<div class="card card-<?php echo $class; ?> is_pdf">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
							<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo6" aria-expanded="false" aria-controls="collapseTwo6" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
								<?php echo $recommendation_word; ?>
							</div>
			...
			<div class="col-12">
				<div class="card card-<?php echo $class;?> is_pdf">
					...
					<div class="card-body chart-responsive minus">
						...
						<div class="row">
							<div class="col-12">
								<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo7" aria-expanded="false" aria-controls="collapseTwo7" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
									<?php echo $recommendation_word; ?>
								</div>
					...
					<div class="card-body chart-responsive minus">
						...
						<div class="row">
							<div class="col-12">
								...
								<?php if($is_pdf != 1) : ?>
								<br/><br/>
								<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo8" aria-expanded="false" aria-controls="collapseTwo8" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
									<?php echo $recommendation_word; ?>
								</div>
						...
						<div class="row">
							<div class="col-12 col-sm-12 col-md-6 col-lg-6 box-card">
								<div class="card card-statistic-1">
									...
									<div class="card-wrap">
										<div class="card-header margin-top">
											<h4><?php echo __("Total Internal Links?"); ?></h4>
										</div>
										<div class="card-body <?php echo $pdf_card; ?>"><?php echo $site_info->internal_link_count;?></div>
									</div>
								</div>
							</div>
							<div class="col-12 col-sm-12 col-md-6 col-lg-6 box-card">
								<div class="card card-statistic-1">
									...
									<div class="card-wrap">
										...
										<div class="card-body <?php echo $pdf_card; ?>"><?php echo $site_info->external_link_count;?></div>
									</div>
								</div>
							</div>
				...
				<div class="card card-<?php echo $class; ?>">
					...
					<div class="card-body chart-responsive minus">
						<div class="row">
							...
							<div class="col-12 col-sm-12 <?php if($compare_report == 0) echo "col-md-4 col-lg-4"; else echo "col-md-6 col-lg-6"; ?>">
								<div class="card card-statistic-1 border">
									...
									<div class="card-wrap">
										<div class="card-header margin-top">
											<h4><?php echo __("IP"); ?></h4>
										</div>
										<div class="card-body <?php echo $pdf_card; ?> text-15"><?php echo $domain_ip_info["ip"] ?? '';?></div>
									</div>
								</div>
							</div>
							...
							<div class="col-12 col-sm-12 <?php if($compare_report == 0) echo "col-md-4 col-lg-4"; else echo "col-md-6 col-lg-6"; ?>">
								<div class="card card-statistic-1 border">
									...
									<div class="card-wrap">
										<div class="card-header margin-top">
											<h4><?php echo __("City"); ?></h4>
										</div>
										<div class="card-body <?php echo $pdf_card; ?> text-15"><?php echo $domain_ip_info["city"] ?? '';?></div>
									</div>
								</div>
							</div>
							...
							<div class="col-12 col-sm-12 <?php if($compare_report == 0) echo "col-md-4 col-lg-4"; else echo "col-md-6 col-lg-6"; ?>">
								<div class="card card-statistic-1 border">
									...
									<div class="card-wrap">
										<div class="card-header margin-top">
											<h4><?php echo __("Country"); ?></h4>
										</div>
										<div class="card-body <?php echo $pdf_card; ?> text-15"><?php echo $domain_ip_info["country"] ?? '';?></div>
									</div>
								</div>
							</div>
							<div class="col-12 col-sm-12 <?php if($compare_report == 0) echo "col-md-4 col-lg-4"; else echo "col-md-6 col-lg-6"; ?>">
								<div class="card card-statistic-1 border">
									...
									<div class="card-wrap">
										...
										<div class="card-body <?php echo $pdf_card; ?> text-15"><?php echo $domain_ip_info["time_zone"] ?? '';?></div>
									</div>
								</div>
							</div>
							<div class="col-12 col-sm-12 <?php if($compare_report == 0) echo "col-md-4 col-lg-4"; else echo "col-md-6 col-lg-6"; ?>">
								<div class="card card-statistic-1 border">
									...
									<div class="card-wrap">
										<div class="card-header margin-top">
											<h4><?php echo __("Longitude"); ?></h4>
										</div>
										<div class="card-body <?php echo $pdf_card; ?> text-15"><?php echo $domain_ip_info["longitude"] ?? '';?></div>
									</div>
								</div>
							</div>
							<div class="col-12 col-sm-12 <?php if($compare_report == 0) echo "col-md-4 col-lg-4"; else echo "col-md-6 col-lg-6"; ?>">
								<div class="card card-statistic-1 border">
									...
									<div class="card-wrap">
										<div class="card-header margin-top">
											<h4><?php echo __("Latitude"); ?></h4>
										</div>
										<div class="card-body <?php echo $pdf_card; ?> text-15"><?php echo $domain_ip_info["latitude"] ?? '';?></div>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="col-12">				
				...
				<div class="card card-<?php echo $class; ?>">
					...
					<div class="card-body chart-responsive minus">
						<div class="row">
							<div class="col-12 <?php if($compare_report == 0) echo "col-md-4 col-lg-4"; else echo "col-md-6 col-lg-6"; ?>">
								<div class="card card-statistic-1 border">
									...
									<div class="card-wrap">
										<div class="card-header margin-top">
											<h4><?php echo __("Total NoIndex Links"); ?></h4>
										</div>
										<div class="card-body <?php echo $pdf_card; ?> text-15"><?php echo count(json_decode($site_info->noindex_list,true)); ?></div>
									</div>
								</div>
							</div>
							...
							<div class="col-12 <?php if($compare_report == 0) echo "col-md-4 col-lg-4"; else echo "col-md-6 col-lg-6"; ?>">
								<div class="card card-statistic-1 border">
									...
									<div class="card-wrap">
										<div class="card-header margin-top">
											<h4><?php echo __("Total NoFollow Links"); ?></h4>
										</div>
										<div class="card-body <?php echo $pdf_card; ?> text-15"><?php echo $site_info->nofollow_link_count; ?></div>
									</div>
								</div>
							</div>
							...
							<div class="col-12 <?php if($compare_report == 0) echo "col-md-4 col-lg-4"; else echo "col-md-6 col-lg-6"; ?>">
								<div class="card card-statistic-1 border">
									...
									<div class="card-wrap">
										<div class="card-header margin-top">
											<h4><?php echo __("Total DoFollow Links"); ?></h4>
										</div>
										<div class="card-body <?php echo $pdf_card; ?> text-15"><?php echo $site_info->dofollow_link_count; ?></div>
									</div>
								</div>
							</div>
							...
							<div class="col-12 <?php if($compare_report == 0) echo "col-md-6 col-lg-6"; else echo "col-md-6 col-lg-6"; ?>">
								<div class="card card-statistic-1 border">
									...
									<div class="card-wrap">
										<div class="card-header margin-top">
											<h4><?php echo __("NoIndex Enabled by Meta Robot?"); ?></h4>
										</div>
										<div class="card-body <?php echo $pdf_card; ?> text-15"><?php echo $site_info->noindex_by_meta_robot;?></div>
									</div>
								</div>
							</div>
							...
							<div class="col-12 <?php if($compare_report == 0) echo "col-md-6 col-lg-6"; else echo "col-md-6 col-lg-6"; ?>">
								<div class="card card-statistic-1 border">
									...
									<div class="card-wrap">
										<div class="card-header margin-top">
											<h4><?php echo __("NoFollow Enabled by Meta Robot?"); ?></h4>
										</div>
										<div class="card-body <?php echo $pdf_card; ?> text-15"><?php echo $site_info->nofollowed_by_meta_robot;?></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-12">
								<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo10" aria-expanded="false" aria-controls="collapseTwo10" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
									<?php echo $recommendation_word; ?>
								</div>
			...
			<div class="<?php if($compare_report == 1 && $is_pdf == 1) echo 'col-12'; else echo 'col-6';?>">				
				...
				<div class="card card-<?php echo $class; ?>">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
						<br>
						<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo11" aria-expanded="false" aria-controls="collapseTwo11" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
							<?php echo $recommendation_word; ?>
						</div>
			...
			<div class="<?php if($compare_report == 1 && $is_pdf == 1) echo 'col-12'; else echo 'col-6';?>">				
				...
				<div class="card card-<?php echo $class; ?>">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
						<br>
						<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo23" aria-expanded="false" aria-controls="collapseTwo23" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
							<?php echo $recommendation_word; ?>
						</div>
						<div id="collapseTwo23" class="accordion-collapse collapse" >
							<div class="accordion-body section-lead alert alert-light long-recom">
								<?php echo $long_recommendation; ?>
							</div>
						</div>
			...
			<div class="<?php if($compare_report == 1 && $is_pdf == 1) echo 'col-12'; else echo 'col-6';?>">				
				...
				<div class="card card-<?php echo $class; ?>">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
						<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo12" aria-expanded="false" aria-controls="collapseTwo12" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
							<?php echo $recommendation_word; ?>
						</div>
			...
			<div class="<?php if($compare_report == 1 && $is_pdf == 1) echo 'col-12'; else echo 'col-6';?>">				
				...
				<div class="card card-<?php echo $class; ?>">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
						<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo14" aria-expanded="false" aria-controls="collapseTwo14" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
							<?php echo $recommendation_word; ?>
						</div>
						<div id="collapseTwo14" class="accordion-collapse collapse" >
							<div class="accordion-body section-lead alert alert-light long-recom">
								<?php echo $long_recommendation; ?>
							</div>
						</div>
			...
			<div class="<?php if($compare_report == 1 && $is_pdf == 1) echo 'col-12'; else echo 'col-6';?>">				
				...
				<div class="card card-<?php echo $class; ?>">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
						<br>
						<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo13" aria-expanded="false" aria-controls="collapseTwo13" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
							<?php echo $recommendation_word; ?>
						</div>
						<div id="collapseTwo13" class="accordion-collapse collapse" >
							<div class="accordion-body section-lead alert alert-light long-recom">
								<?php echo $long_recommendation; ?>
							</div>
						</div>
			...
			<div class="<?php if($compare_report == 1 && $is_pdf == 1) echo 'col-12'; else echo 'col-6';?>">				
				...
				<div class="card card-<?php echo $class; ?>">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
						<br>
						<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo15" aria-expanded="false" aria-controls="collapseTwo15" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
							<?php echo $recommendation_word; ?>
						</div>
						<div id="collapseTwo15" class="accordion-collapse collapse" >
							<div class="accordion-body section-lead alert alert-light long-recom">
								<?php echo $long_recommendation; ?>
							</div>
						</div>
			...
			<div class="<?php if($compare_report == 1 && $is_pdf == 1) echo 'col-12'; else echo 'col-6';?>">				
				...
				<div class="card card-<?php echo $class; ?>">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
						<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo16" aria-expanded="false" aria-controls="collapseTwo16" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
							<?php echo $recommendation_word; ?>
						</div>
						<div id="collapseTwo16" class="accordion-collapse collapse" >
							<div class="accordion-body section-lead alert alert-light long-recom">
								<?php echo $long_recommendation; ?>
							</div>
						</div>
			...
			<div class="<?php if($compare_report == 1 && $is_pdf == 1) echo 'col-12'; else echo 'col-6';?>">				
				...
				<div class="card card-<?php echo $class; ?>">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
						<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo17" aria-expanded="false" aria-controls="collapseTwo17" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
							<?php echo $recommendation_word; ?>
						</div>
						<div id="collapseTwo17" class="accordion-collapse collapse" >
							<div class="accordion-body section-lead alert alert-light long-recom">
								<?php echo $long_recommendation; ?>
							</div>
						</div>
			...
			<div class="col-12">				
				...
				<div class="card card-<?php echo $class; ?>">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
						<br>
						<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo18" aria-expanded="false" aria-controls="collapseTwo18" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
							<?php echo $recommendation_word; ?>
						</div>
						<div id="collapseTwo18" class="accordion-collapse collapse" >
							<div class="accordion-body section-lead alert alert-light long-recom">
								<?php echo $long_recommendation; ?>
							</div>
						</div>
			...
			<div class="<?php if($compare_report == 1 && $is_pdf == 1) echo 'col-12'; else echo 'col-6';?>">				
				...
				<div class="card card-<?php echo $class; ?>">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
						<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo19" aria-expanded="false" aria-controls="collapseTwo19" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
							<?php echo $recommendation_word; ?>
						</div>
						<div id="collapseTwo19" class="accordion-collapse collapse" >
							<div class="accordion-body section-lead alert alert-light long-recom">
								<?php echo $long_recommendation; ?>
							</div>
						</div>
			...
			<div class="<?php if($compare_report == 1 && $is_pdf == 1) echo 'col-12'; else echo 'col-6';?>">				
				...
				<div class="card card-<?php echo $class; ?>">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
						<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo20" aria-expanded="false" aria-controls="collapseTwo20" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
							<?php echo $recommendation_word; ?>
						</div>
						<div id="collapseTwo20" class="accordion-collapse collapse" >
							<div class="accordion-body section-lead alert alert-light long-recom">
								<?php echo $long_recommendation; ?>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-12 col-md-6">
								<div class="card card-statistic-1 border">
									...
									<div class="card-wrap">
										<div class="card-header margin-top">
											<h4><?php echo __('IPv4'); ?></h4>
										</div>
										<div class="card-body <?php echo $pdf_card; ?>">
											<?php echo $site_info->ip;?>
										</div>
									</div>
								</div>
							</div>
							<div class="col-12 col-md-6">
								<div class="card card-statistic-1 border">
									...
									<div class="card-wrap">
										<div class="card-header margin-top">
											<h4><?php echo __('IPv6'); ?></h4>
										</div>
										<div class="card-body <?php echo $pdf_card; ?>">
											<?php if($site_info->is_ipv6_compatiable==0) echo "<small>".__("Not Compatiable")."</small>"; else echo $site_info->ipv6;?>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="<?php if($compare_report == 1 && $is_pdf == 1) echo 'col-12'; else echo 'col-6';?>">				
				...
				<div class="card card-<?php echo $class; ?>">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
						<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo21" aria-expanded="false" aria-controls="collapseTwo21" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
							<?php echo $recommendation_word; ?>
						</div>
						<div id="collapseTwo21" class="accordion-collapse collapse" >
							<div class="accordion-body section-lead alert alert-light long-recom">
								<?php echo $long_recommendation; ?>
							</div>
						</div>
			...
			<div class="<?php if($compare_report == 1 && $is_pdf == 1) echo 'col-12'; else echo 'col-6';?>">				
				...
				<div class="card card-<?php echo $class; ?>">
					...
					<div class="card-body chart-responsive minus">
						...
						<?php if($is_pdf != 1) : ?>
						<div class="collapsed section-title" type="" data-bs-toggle="collapse" data-bs-target="#collapseTwo22" aria-expanded="false" aria-controls="collapseTwo22" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>">
							<?php echo $recommendation_word; ?>
						</div>
		...
		<div class="row">
			<div class="col-12">				
				...
				<div class="card card-<?php echo $class; ?>">
					...
					<div class="card-body chart-responsive minus p-0">
						<ul class="list-group pdf-heading px-3">
							<div class="row">
								...
								?>
									<div class="col-12 col-md-6 p-0">
										<li class="list-group-item rounded-0 border-top-0"><b><?php echo str_replace("_"," ",$key); ?></b> : <span class="text-13"><?php echo $value; ?></span></li>
									</div>
						...
						<?php else: ?>
								...
								<div class="col-12 col-md-6">
									...
									<?php else : ?>
										<p class="text-center position-relative;">
										    ...
										    <div class="d-inline w-120 h-120"><canvas width="120" height="120"></canvas><input type="text" class="dial knob" data-readonly="true" value="<?php echo $mobile_score; ?>" data-width="120" data-height="120" data-fgcolor="#6777ef" data-thickness=".1" readonly="readonly" ></div>
										</p>
							...
							<div class="row mt-5">
								<div class="<?php if($compare_report == 1) echo "col-12"; else echo "col-12 col-md-8"; ?> ">
									<ul class="list-group pdf-heading">
										<li class="list-group-item active"><?php echo __("Field Data"); ?>
											<i data-description="<h2 class='section-title'><?php echo __('Field Data'); ?></h2> <p style='font-size: 12px;'><?php echo __('Over the last 30 days, the field data shows that this page has an <b>Moderate</b> speed compared to other pages in the') ?> <b><a target='_BLANK' href='https://developers.google.com/web/tools/chrome-user-experience-report/'></b> <?php echo __('Chrome User Experience Report') ?></a>. <?php echo __('We are showing') ?> <b> <a target='_BLANK' href='https://developers.google.com/speed/docs/insights/v5/about#faq'><?php echo __('the 75th percentile of FCP') ?></b> <b></a> and <a target='_BLANK' href='https://developers.google.com/speed/docs/insights/v5/about#faq'><?php echo __('the 95th percentile of FID') ?></a></b></p>" class="fas fa-info-circle field_data_modal bg-white"></i>
										</li>  
								...
								<div class="<?php if($compare_report ==1) echo "col-12 mt-5"; else echo "col-12 col-md-4 pl-4"; ?> ">
									<div 
										<?php 
											$bgpos = '';
											if($is_pdf == 1) $bgpos = "background-position: top center;text-align:left;padding-left:12px!important;";
							...
							<div class="row mt-4">
								<div class="<?php if($compare_report ==1) echo "col-12"; else echo "col-12 col-md-6" ?>">
	                                <ul class="list-group pdf-heading">
	                                    <li class="list-group-item active"> <?php echo __('Origin Summary'); ?> <i data-description="<h2 class='section-title'><?php echo __('Origin Summary Data'); ?></h2><p style='font-size: 12px;'> <?php echo __('All pages served from this origin have a <b>Slow</b> speed compared to other pages in the'); ?> <a target='_BLANK' href='https://developers.google.com/web/tools/chrome-user-experience-report/'><?php echo __('Chrome User Experience Report') ?></a> <?php echo __('over the last 30 days.To view suggestions tailored to each page, analyze individual page URLs.') ?></p>" class="fas fa-info-circle field_data_modal bg-white"></i>
	                                    </li>
								...
								<div class="<?php if($compare_report ==1) echo "col-12 mt-5"; else echo "col-12 col-md-6" ?>">
	                                <ul class="list-group pdf-heading">
	                                    ...
	                                    <div class="heading_styles h-auto">
	                                    	<li class="list-group-item">
	                                    	    <?php echo __('First Contentful Paint'); ?><i data-description="<h2 class='section-title'><?php echo __('First Contentful Paint'); ?></h2> <p style='font-size: 12px;line-height: initial;'><?php echo __('First Contentful Paint marks the time at which the first text or image is painted.'); ?> <b><a target='_BLANK' class='text-danger' href='https://web.dev/first-contentful-paint/?utm_source=lighthouse&utm_medium=unknown'><?php echo __('Learn more'); ?></a></b> </p>" class="fas fa-info-circle field_data_modal ml-auto"></i>
	                                    	    <span class="badge badge-primary badge-pill">
	                                    	        <?php 
	                                    	...
	                                    	<li class="list-group-item">
	                                    	    <?php echo __('First Meaningful Paint'); ?><i data-description="<h2 class='section-title'><?php echo __('First Meaningful Paint'); ?></h2>
	                                    	        <p class='text-12 line-height-initial'><?php echo __('First Meaningful Paint measures when the primary content of a page is visible.'); ?> <b><a target='_BLANK' class='text-danger' href='https://web.dev/first-meaningful-paint?utm_source=lighthouse&utm_medium=unknown'><?php echo __('Learn more'); ?></a></b> </p>" class="fas fa-info-circle field_data_modal mr-282"></i>
	                                    	    <span class="badge badge-primary badge-pill">
	                                    	        <?php 
	                                    	...
	                                    	<li class="list-group-item">
	                                    	    <?php echo __('Speed Index'); ?> <i data-description="<h2 class='section-title'><?php echo __('Speed Index'); ?></h2>
	                                    	    <p class='text-12 line-height-initial'><?php echo __('Speed Index shows how quickly the contents of a page are visibly populated.'); ?> <b><a target='_BLANK' class='text-danger' href='https://web.dev/speed-index?utm_source=lighthouse&utm_medium=unknown'><?php echo __('Learn more'); ?></a></b> </p>" class="fas fa-info-circle field_data_modal mr-330"></i>
	                                    	    <span class="badge badge-primary badge-pill">
	                                    	       <?php 
	                                    	...
	                                    	<li class="list-group-item">
	                                    	    <?php echo __('First CPU Idle'); ?> <i data-description="<h2 class='section-title'><?php echo __('First CPU Idle'); ?></h2>
	                                    	    <p class='text-12 line-height-initial'><?php echo __('First CPU Idle marks the first time at which the page main thread is quiet enough to handle input.'); ?> <b><a target='_BLANK' class='text-danger' href='https://web.dev/first-cpu-idle?utm_source=lighthouse&utm_medium=unknown'><?php echo __('Learn more'); ?></a></b> </p>" class="fas fa-info-circle field_data_modal mr-320"></i>
	                                    	    <span class="badge badge-primary badge-pill">
	                                    	       <?php 
	                                    	...
	                                    	<li class="list-group-item">
	                                    	    <?php echo __('Time to Interactive'); ?> <i class="fas fa-info-circle field_data_modal mr-290" data-description="<h2 class='section-title'><?php echo __('Time to Interactive'); ?></h2>
	                                    	    <p class='text-12 line-height-initial'><?php echo __('Time to interactive is the amount of time it takes for the page to become fully interactive.'); ?> <b><a target='_BLANK' class='text-danger' href='https://web.dev/interactive/?utm_source=lighthouse&utm_medium=unknown'><?php echo __('Learn more'); ?></a></b> </p>"></i>
	                                    	    <span class="badge badge-primary badge-pill">
	                                    	        <?php 
	                                    	...
	                                    	<li class="list-group-item">
	                                    	    <?php echo __('Max Potential First Input Delay'); ?> <i class="fas fa-info-circle field_data_modal mr-200"  data-description="<h2 class='section-title'><?php echo __('Max Potential First Input Delay'); ?></h2>
	                                    	        <p class='text-12 line-height-initial'><?php echo __('The maximum potential First Input Delay that your users could experience is the duration, in milliseconds, of the longest task.'); ?> <b><a target='_BLANK' class='text-danger' href='https://web.dev/fid/'><?php echo __('Learn more'); ?></a></b> </p>"></i>
	                                    	    <span class="badge badge-primary badge-pill">
	                                    	        <?php 
							...
							<div class="row mt-5">
								<div class="col-12">
								    <div class="card card-primary">
								         ...
								         <div class="card-body chart-responsive minus p-0 row">
											<?php if(isset($mobile_lighthouseresult_audits['resource-summary']['title'])) : ?>
											<!-- <div class="row mt-5"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											                <h4 class="text-success"><i class="fa fa-ellipsis-h"></i> 
																<?php 
											...
											<?php if(isset($mobile_lighthouseresult_audits['time-to-first-byte']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['render-blocking-resources']['title'])) : ?>	
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['uses-optimized-images']['title'])) :?>	
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['uses-text-compression']['title'])) : ?>		
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['uses-long-cache-ttl']['title'])) : ?>	
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['third-party-summary']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['estimated-input-latency']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['first-contentful-paint-3g']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['total-blocking-time']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['bootup-time']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['offscreen-images']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['network-server-latency']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['uses-responsive-images']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['unused-css-rules']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['total-byte-weight']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['mainthread-work-breakdown']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['uses-webp-images']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['critical-request-chains']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['dom-size']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['redirects']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['unminified-javascript']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['user-timings']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($mobile_lighthouseresult_audits['network-rtt']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
					...
					<div class="card-body" id="mobile-collapse">
						...
						<?php else: ?>
							...
							<div class="row mt-5">
								<div class="col-12 col-md-6">
	                                <ul class="list-group pdf-heading">
	                                    <li class="list-group-item active"> <?php echo __('Field Data'); ?> <i data-description="<h2 class='section-title'><?php echo __('Field Data'); ?></h2> <p class='text-12'><?php echo __('Over the last 30 days, the field data shows that this page has an <b>Moderate</b> speed compared to other pages in the') ?> <b><a target='_BLANK' href='https://developers.google.com/web/tools/chrome-user-experience-report/'></b> <?php echo __('Chrome User Experience Report') ?></a>. <?php echo __('We are showing') ?> <b> <a target='_BLANK' href='https://developers.google.com/speed/docs/insights/v5/about#faq'><?php echo __('the 75th percentile of FCP') ?></b> <b></a> and <a target='_BLANK' href='https://developers.google.com/speed/docs/insights/v5/about#faq'><?php echo __('the 95th percentile of FID') ?></a></b></p>" class="fas fa-info-circle field_data_modal bg-white"></i>
	                                    </li>
	                                    <div class="heading_styles h-auto">
	                                    	<li class="list-group-item">
	                                    	    <?php echo __('First Contentful Paint (FCP)'); ?>
							...
							<div class="row mt-5">
								<div class="<?php if($compare_report ==1) echo "col-12"; else echo "col-12 col-md-6" ?>">
	                                <ul class="list-group pdf-heading">
	                                    <li class="list-group-item active"> <?php echo __('Origin Summary'); ?> <i data-description="<h2 class='section-title'><?php echo __('Origin Summary Data'); ?></h2><p class='text-12'> <?php echo __('All pages served from this origin have a <b>Slow</b> speed compared to other pages in the'); ?> <a target='_BLANK' href='https://developers.google.com/web/tools/chrome-user-experience-report/'><?php echo __('Chrome User Experience Report') ?></a> <?php echo __('over the last 30 days.To view suggestions tailored to each page, analyze individual page URLs.') ?></p>" class="fas fa-info-circle field_data_modal bg-white" ></i>
	                                    </li>
	                                    <div class="heading_styles h-auto">
	                                    	<li class="list-group-item">
	                                    	    <?php echo __('First Contentful Paint (FCP)'); ?>
								...
								<div class="<?php if($compare_report ==1) echo "col-12 mt-5"; else echo "col-12 col-md-6"; ?>">
	                                <ul class="list-group pdf-heading">
	                                    ...
	                                    <div class="heading_styles h-auto">
	                                    	<li class="list-group-item">
	                                    	    <?php echo __('First Contentful Paint'); ?><i data-description="<h2 class='section-title'><?php echo __('First Contentful Paint'); ?></h2> <p class='text-12 line-height-initial;'><?php echo __('First Contentful Paint marks the time at which the first text or image is painted.'); ?> <b><a target='_BLANK' class='text-danger' href='https://web.dev/first-contentful-paint/?utm_source=lighthouse&utm_medium=unknown'><?php echo __('Learn more'); ?></a></b> </p>" class="fas fa-info-circle field_data_modal mr-282"></i>
	                                    	    <span class="badge badge-primary badge-pill">
	                                    	        <?php 
	                                    	...
	                                    	<li class="list-group-item">
	                                    	    <?php echo __('Max Potential First Input Delay'); ?> <i class="fas fa-info-circle field_data_modal mr-290" data-description="<h2 class='section-title'><?php echo __('Max Potential First Input Delay'); ?></h2>
	                                    	        <p class='text-12 line-height-initial'><?php echo __('The maximum potential First Input Delay that your users could experience is the duration, in milliseconds, of the longest task.'); ?> <b><a target='_BLANK' class='text-danger' href='https://web.dev/fid/'><?php echo __('Learn more'); ?></a></b> </p>"></i>
	                                    	    <span class="badge badge-primary badge-pill">
	                                    	        <?php 
								...
								<div class="col-12">
								    <div class="card card-primary">
								        ...
								        <div class="card-body chart-responsive minus p-0 row">
											...
											<?php if(isset($desktop_lighthouseresult_audits['resource-summary']['title'])) : ?>
											<!-- <div class="row mt-5"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['time-to-first-byte']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['render-blocking-resources']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['uses-optimized-images']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['uses-text-compression']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['uses-long-cache-ttl']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['third-party-summary']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['estimated-input-latency']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['first-contentful-paint-3g']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['total-blocking-time']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['bootup-time']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['offscreen-images']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['network-server-latency']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['uses-responsive-images']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['unused-css-rules']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['total-byte-weight']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['mainthread-work-breakdown']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['uses-webp-images']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['critical-request-chains']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['dom-size']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['redirects']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['unminified-javascript']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['user-timings']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
											...
											<?php if(isset($desktop_lighthouseresult_audits['network-rtt']['title'])) : ?>
											<!-- <div class="row mt-3"> -->
											    <div class="col-6">
											        <div class="card card-success">
											            <div class="card-header">
...
<?php if($compare_report==0 && $load_css_js!=1) { ?>
<script>
	var reportUri = "{{ route('domain.download.report',$site_info->auto_id??$site_info->id) }}";
...
<?php if($is_pdf==0) : ?>
	<script>
		var compare="1";
		var base_site="<?php echo $site_info->auto_id ?? ""; ?>";
