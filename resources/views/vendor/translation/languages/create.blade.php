            ...
            <fieldset>
                ...
                <div class="panel-body p-4">
                    ...
                    <div class="form-group">
                        ...
                        <select name="locale" id="locale" class="form-control" style="width: 100%;">
                    ...
                    @include('translation::forms.text', ['field' => 'locale', 'label' => __('translation::translation.locale'), 'value'=> isset($selectedLang) ? $selectedLang: '']) --}}
