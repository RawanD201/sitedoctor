        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <thead>
                        <tr>
                            <th style="text-align: center;">{{ __('translation::translation.language_name') }}</th>
    ...
    @else
        ...
        <div id="error">
            <div class="container text-center pt-32">
                <p style="font-size:30px;margin-bottom:20px;">{{ __("Sorry, we couldn't find any language to show.") }}</p>
