...
@section('content')
    ...
    <div class="main-content container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-12 <?php echo $is_admin ? 'text-center' : ''?>">
                    <h3>{{ __('Account') }}</h3>
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        @endphp
                                                        <div class="row">
                                                            <div class="col-4 col-md-2"><img src="{{ $profile_pic }}" width="70" height="70" class="border rounded-circle" alt="" style="">
                                                            </div>
                                                    ...
                                                    <div class="col-12 mt-4">
                                                        ...
                                                        {{--<button type="button" class="btn btn-light-secondary me-1 mb-1" id="reset_btn">{{ __('Reset') }}</button>--}}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
