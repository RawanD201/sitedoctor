 ...
 <link rel="stylesheet" href="{{ asset('assets/css/pages/update.css') }}">
	...
	<section class="section">
		<div class="section-header">
			<h1><i class="fas fa-leaf"></i> <?php echo config("product_name"); ?> : <?php echo __("Updates"); ?></h1>
		</div>
			        	...
			        	<div class="table-responsive2">
			        		<table class='table table-bordered table-striped table-md'>
				        		...
				        		foreach($update_versions as $update_version)
				        		{
				        			...
				        			?>		
				        			<tr>
				        				<td class="text-center" ><div class="badge badge-info text-dark">v<?php echo $update_version->version; ?></div></td>
				        				<td class="text-center">
				        					<button class='btn btn-outline-primary' data-toggle="modal" data-target="#<?php echo $modal; ?>"><i class='fa fa-eye'></i> <?php echo __('See Log');?></button>
				        					<!-- Modal -->
...
<script src="{{ asset('assets/js/internal-js/update-index-v2.js') }}"></script>
@endpush